...
Return ONLY valid JSON, no markdown, no extra text:
{{
  "quote_en": "the FULL quote in English (keep it complete, do not cut it short)",
  "author": "author name",
  "quote_ua": "Ukrainian translation of the FULL quote"
}}
Rules:
- Simple A2 vocabulary
- Short and memorable
...
Return ONLY valid JSON, no markdown, no extra text:
{{
  "quote_en": "the FULL motivational quote in English (keep it complete, do not cut it short)",
  "author": "author name",
  "quote_ua": "Ukrainian translation of the FULL quote"
}}
Rules:
